...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bb4458, const void *arg_0xb7bb45f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b658c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a0f840), 
int (*key_eq_fn)(void *arg_0xb7a0fc88, void *arg_0xb7a0fe00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78de9b8, int arg_0xb78deb10);
static double RandomUniform(void );
...
typedef nx_struct MQTT_msg {
  ...
  nx_uint8_t topic;
  nx_uint16_t payload;
} __attribute__((packed)) MQTT_msg_t;
...
typedef nx_struct client_table {
  ...
  nx_uint8_t topic[3];
} __attribute__((packed)) client_table_t;
...
# 24 "/usr/include/i386-linux-gnu/bits/confname.h" 3
...
# 43 "/usr/include/i386-linux-gnu/bits/uio.h" 3
struct iovec {

  void *iov_base;
  size_t iov_len;
};
# 24 "/usr/include/i386-linux-gnu/bits/socket_type.h" 3
enum __socket_type {
...
# 28 "/usr/include/i386-linux-gnu/bits/sockaddr.h" 3
typedef unsigned short int sa_family_t;
# 153 "/usr/include/i386-linux-gnu/bits/socket.h" 3
struct sockaddr {
...
# 43 "/usr/include/i386-linux-gnu/sys/socket.h" 3
struct osockaddr {
...
# 133 "/usr/include/i386-linux-gnu/bits/in.h" 3
struct ip_opts {
...
typedef TMilli Project1C$Timer0$precision_tag;
typedef TMilli Project1C$Timer1$precision_tag;
typedef TMilli Project1C$Timer3$precision_tag;
typedef TMilli Project1C$Timer2$precision_tag;
...
static void Project1C$Timer0$fired(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void Project1C$AMControl$startDone(error_t error);
#line 138
static void Project1C$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void Project1C$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void Project1C$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void Project1C$Timer1$fired(void );
#line 83
static void Project1C$Timer3$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void Project1C$Timer2$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static bool Project1C$Timer0$isRunning(void );
#line 73
static void Project1C$Timer0$startOneShot(uint32_t dt);
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t Project1C$AMControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t Project1C$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t Project1C$Random$rand16(void );
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void Project1C$Timer1$startOneShot(uint32_t dt);
#line 73
static void Project1C$Timer3$startOneShot(uint32_t dt);
#line 73
static void Project1C$Timer2$startOneShot(uint32_t dt);
# 42 "Project1C.nc"
int Project1C$sockfd[1000];
struct sockaddr_in Project1C$servaddr[1000];


message_t Project1C$packet[1000];


message_t Project1C$queued_packet[1000];
uint16_t Project1C$queue_addr[1000];


bool Project1C$connection[1000];
bool Project1C$sub_wish[1000][3];
bool Project1C$sub_done[1000][3];
uint8_t Project1C$num_topic[1000];
uint8_t Project1C$num_sub[1000];
uint8_t Project1C$topic_pub[1000];
...
#line 60
typedef struct Project1C$message_list {
  MQTT_msg_t saved_msg;
  uint16_t dest_id;
  struct Project1C$message_list *next;
} Project1C$message_list_t;

Project1C$message_list_t *Project1C$message_list[1000];
client_list_t Project1C$client_list[1000][9 - 1];


bool Project1C$locked[1000];



const char *Project1C$topic_name[1000][3];

static inline bool Project1C$actual_send(uint16_t address, message_t *packet);
static bool Project1C$generate_send(uint16_t address, message_t *packet);


static inline void Project1C$connectPAN(void );
static inline void Project1C$subscribe(void );
static inline void Project1C$publish(void );
static inline void Project1C$choose_topic(void );
static inline void Project1C$init_client_list(void );

static inline bool Project1C$is_empty_message_list(Project1C$message_list_t **list);
static void Project1C$push_message(Project1C$message_list_t **list, MQTT_msg_t msg, uint16_t address);
static inline uint16_t Project1C$pop_message(Project1C$message_list_t **list, MQTT_msg_t *message);

static inline void Project1C$Boot$booted(void );




static inline void Project1C$AMControl$startDone(error_t err);
#line 113
static inline void Project1C$Timer0$fired(void );



static inline void Project1C$Timer1$fired(void );
#line 132
static inline void Project1C$Timer2$fired(void );
...
static inline void Project1C$Timer3$fired(void );
...
static inline bool Project1C$actual_send(uint16_t address, message_t *packet);
#line 177
static inline void Project1C$AMSend$sendDone(message_t *bufPtr, error_t error);





static inline void Project1C$AMControl$stopDone(error_t err);




static inline message_t *Project1C$Receive$receive(message_t *bufPtr, 
...
static inline void Project1C$init_client_list(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * Project1C$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 189
{
  ...
  if (len != sizeof(MQTT_msg_t )) {
      sim_log_error(152U, "radio", "NODE %d Receiving corrupted message\n", TOS_NODE_ID);
      return bufPtr;
    }
  else {
      MQTT_msg_t *received_msg = (MQTT_msg_t *)payload;
      MQTT_msg_t *msg = (MQTT_msg_t *)Project1C$Packet$getPayload(&Project1C$packet[sim_node()], sizeof(MQTT_msg_t ));
      uint8_t i;

      switch (__nesc_ntoh_uint8(received_msg->type.nxdata)) {

          case CONNECT: 
            if (__nesc_ntoh_uint8(Project1C$client_list[sim_node()][__nesc_ntoh_uint16(received_msg->id.nxdata) - 1].connected.nxdata) == FALSE) {
                __nesc_hton_uint8(msg->type.nxdata, CONNACK);
                __nesc_hton_uint8(Project1C$client_list[sim_node()][__nesc_ntoh_uint16(received_msg->id.nxdata) - 1].connected.nxdata, TRUE);
                sim_log_debug(153U, "connect", "PAN receiving CONNECT from %d\n", __nesc_ntoh_uint16(received_msg->id.nxdata));
                sim_log_debug(154U, "list", "PAN quequed CONNACK to CLIENT %d\n", __nesc_ntoh_uint16(received_msg->id.nxdata));
                Project1C$push_message(&Project1C$message_list[sim_node()], *msg, __nesc_ntoh_uint16(received_msg->id.nxdata));
              }
          break;

          case CONNACK: 
            Project1C$connection[sim_node()] = TRUE;
          sim_log_debug(155U, "connect", "CLIENT %d receiving CONNACK from PAN\n", TOS_NODE_ID);
          break;

          case SUBSCRIBE: 
            sim_log_debug(156U, "subscribe", "PAN receiving SUBSCRIBE from %d for topic %s \n", __nesc_ntoh_uint16(received_msg->id.nxdata), Project1C$topic_name[sim_node()][__nesc_ntoh_uint8(received_msg->topic.nxdata)]);
          if (__nesc_ntoh_uint8(Project1C$client_list[sim_node()][__nesc_ntoh_uint16(received_msg->id.nxdata) - 1].topic[__nesc_ntoh_uint8(received_msg->topic.nxdata)].nxdata) == FALSE) {
              __nesc_hton_uint8(msg->type.nxdata, SUBACK);
              __nesc_hton_uint8(msg->topic.nxdata, __nesc_ntoh_uint8(received_msg->topic.nxdata));
              __nesc_hton_uint8(Project1C$client_list[sim_node()][__nesc_ntoh_uint16(received_msg->id.nxdata) - 1].topic[__nesc_ntoh_uint8(msg->topic.nxdata)].nxdata, TRUE);
              sim_log_debug(157U, "list", "PAN quequed SUBACK to CLIENT %d for TOPIC %s \n", TOS_NODE_ID, Project1C$topic_name[sim_node()][__nesc_ntoh_uint8(msg->topic.nxdata)]);
              Project1C$push_message(&Project1C$message_list[sim_node()], *msg, __nesc_ntoh_uint16(received_msg->id.nxdata));
            }
          break;

          case SUBACK: 
            sim_log_debug(158U, "subscribe", "CLIENT %d receiving SUBACK \n", TOS_NODE_ID);
          sim_log_debug(159U, "subscribe", "CLIENT %d is now subscribed on topic %s \n", TOS_NODE_ID, Project1C$topic_name[sim_node()][__nesc_ntoh_uint8(received_msg->topic.nxdata)]);
          Project1C$num_sub[sim_node()]++;
          Project1C$sub_done[sim_node()][__nesc_ntoh_uint8(received_msg->topic.nxdata)] = TRUE;
          break;

          case PUBLISH: 
            __nesc_hton_uint8(msg->type.nxdata, PUBLISH);
          __nesc_hton_uint8(msg->topic.nxdata, __nesc_ntoh_uint8(received_msg->topic.nxdata));
          __nesc_hton_uint16(msg->payload.nxdata, __nesc_ntoh_uint16(received_msg->payload.nxdata));

          if (TOS_NODE_ID == 9) {
              for (i = 0; i < 8; i++) {
                  if (__nesc_ntoh_uint8(Project1C$client_list[sim_node()][i].topic[__nesc_ntoh_uint8(msg->topic.nxdata)].nxdata) == TRUE) {
                      sim_log_debug(160U, "publish", "PAN forwarding PUBLISH: topic %s, value %d to CLIENT %d\n", Project1C$topic_name[sim_node()][__nesc_ntoh_uint8(msg->topic.nxdata)], __nesc_ntoh_uint16(msg->payload.nxdata), i + 1);
                      Project1C$push_message(&Project1C$message_list[sim_node()], *msg, i + 1);
                    }
                }
              sim_log_debug(161U, "publish", "PAN sending PUB messages to Node-RED\n");


              Project1C$sockfd[sim_node()] = socket(2, SOCK_STREAM, 0);
              if (Project1C$sockfd[sim_node()] == -1) 
                {
                  sim_log_debug(162U, "error", "Socket creation failed!\n");
                  return bufPtr;
                }

              Project1C$servaddr[sim_node()].sin_family = 2;
              Project1C$servaddr[sim_node()].sin_addr.s_addr = inet_addr("127.0.0.1");
              Project1C$servaddr[sim_node()].sin_port = htons(1234);

              if (connect(Project1C$sockfd[sim_node()], (struct sockaddr *)&Project1C$servaddr[sim_node()], sizeof Project1C$servaddr[sim_node()]) != 0) 
                {
                  sim_log_debug(163U, "error", "Connection with the server failed!\n");
                  close(Project1C$sockfd[sim_node()]);
                  return bufPtr;
                }

              if (send(Project1C$sockfd[sim_node()], msg, sizeof(MQTT_msg_t ), 0) == -1) 
                {
                  sim_log_debug(164U, "error", "Failed to send message!\n");
                  return bufPtr;
                }
              close(Project1C$sockfd[sim_node()]);
            }
          else {
              sim_log_debug(165U, "publish", "CLIENT %d receiving PUBLISH: TOPIC %s, value %d \n", TOS_NODE_ID, Project1C$topic_name[sim_node()][__nesc_ntoh_uint8(received_msg->topic.nxdata)], __nesc_ntoh_uint16(received_msg->payload.nxdata));
            }
          break;
        }
      return bufPtr;
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb767fac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb767fac8) {
#line 78
    case 10:
#line 78
      __nesc_result = Project1C$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb767fac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb767d178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb767d178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t Project1C$AMControl$start(void ){
#line 104
...
#line 104
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void Project1C$Timer2$startOneShot(uint32_t dt){
#line 73
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t Project1C$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 354
  Project1C$num_sub[sim_node()] = 0;
  Project1C$num_topic[sim_node()] = Project1C$Random$rand16() % 3;
  Project1C$num_topic[sim_node()] = Project1C$num_topic[sim_node()] + 1;

  Project1C$topic_pub[sim_node()] = Project1C$Random$rand16() % 3;

  while (Project1C$sub_wish[sim_node()][0] + Project1C$sub_wish[sim_node()][1] + Project1C$sub_wish[sim_node()][2] != Project1C$num_topic[sim_node()]) 
    {
      uint8_t new_topic = Project1C$Random$rand16() % 3;

#line 363
      Project1C$sub_wish[sim_node()][new_topic] = TRUE;
    }
  sim_log_debug(170U, "boot", "CLIENT %d could PUB on TOPIC %s \n", TOS_NODE_ID, Project1C$topic_name[sim_node()][Project1C$topic_pub[sim_node()]]);

  for (i = 0; i < 3; i++) 
    {
      if (Project1C$sub_wish[sim_node()][i]) 
        {
          sim_log_debug(171U, "boot", "CLIENT %d would like to SUB on TOPIC %s\n", TOS_NODE_ID, Project1C$topic_name[sim_node()][i]);
        }
    }
}

# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void Project1C$Timer1$startOneShot(uint32_t dt){
#line 73
...
#line 380
  sim_log_debug(172U, "boot", "PAN INIT CLIENT LIST\n");

  for (i = 0; i < 9; i++) {
      __nesc_hton_uint8(Project1C$client_list[sim_node()][i].connected.nxdata, FALSE);
      for (j = 0; j < 3; j++) {
          __nesc_hton_uint8(Project1C$client_list[sim_node()][i].topic[j].nxdata, FALSE);
        }
    }
}
...
{
  if (err == SUCCESS) {
      sim_log_debug(149U, "boot", "NODE %d Radio ON!\n", TOS_NODE_ID);
      Project1C$locked[sim_node()] = FALSE;
      if (TOS_NODE_ID == 9) {
          Project1C$init_client_list();
          Project1C$Timer1$startOneShot(300);
        }
      else 
        {
          Project1C$choose_topic();
          Project1C$Timer2$startOneShot(2000);
        }
    }
  else 
    {
#line 110
      Project1C$AMControl$start();
    }
}
...
#line 113
  Project1C$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 183
{
  sim_log_debug(151U, "radio", "NODE %d Radio stopped!\n", TOS_NODE_ID);
}
...
#line 138
  Project1C$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb767f108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb767f108, msg, error);
#line 110
}
#line 110
...
#line 177
{
  if (&Project1C$queued_packet[sim_node()] == bufPtr && error == SUCCESS) {
      Project1C$locked[sim_node()] = FALSE;
    }
}

# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  Project1C$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb741ea98, message_t * msg, error_t error){
#line 100
  switch (arg_0xb741ea98) {
#line 100
    case 0U:
#line 100
      /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb741ea98, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb783a650){
#line 75
  switch (arg_0xb783a650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb783a650);
#line 75
      break;
#line 75
    }
...
#line 53
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb741b498, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb741b498, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 10);
  return /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t Project1C$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*Project1AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 163
{
  ...
  if (Project1C$locked[sim_node()]) {
      return FALSE;
      sim_log_debug(150U, "radio", "NODE %d Radio not avaible\n", TOS_NODE_ID);
    }
  else {
      if (Project1C$AMSend$send(address, packet, sizeof(MQTT_msg_t )) == SUCCESS) {
          Project1C$locked[sim_node()] = TRUE;
        }
      return TRUE;
    }
}
...
#line 113
{
  Project1C$actual_send(Project1C$queue_addr[sim_node()], &Project1C$queued_packet[sim_node()]);
}
...
#line 342
{
  Project1C$message_list_t *current = *list;
...
#line 345
  ...
  *list = current->next;
  free(current);
  sim_log_debug(169U, "list", "PAN pop message to destination %d\n", address);
  return address;
}
...
#line 117
{
  if (Project1C$is_empty_message_list(&Project1C$message_list[sim_node()]) == TRUE) {
      Project1C$Timer1$startOneShot(300);
      return;
    }
  else {
      MQTT_msg_t msg;
      uint16_t address = Project1C$pop_message(&Project1C$message_list[sim_node()], &msg);
      MQTT_msg_t *payload = (MQTT_msg_t *)Project1C$Packet$getPayload(&Project1C$packet[sim_node()], sizeof(MQTT_msg_t ));

#line 126
      *payload = msg;
      Project1C$generate_send(address, &Project1C$packet[sim_node()]);
      Project1C$Timer1$startOneShot(300);
    }
}
...
#line 285
  __nesc_hton_uint8(msg->type.nxdata, CONNECT);
  __nesc_hton_uint16(msg->id.nxdata, TOS_NODE_ID);
  sim_log_debug(166U, "connect", "CLIENT %d trying to CONNECT to PANC\n", TOS_NODE_ID);
  Project1C$generate_send(9, &Project1C$packet[sim_node()]);
  Project1C$Timer2$startOneShot(2000);
}

# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void Project1C$Timer3$startOneShot(uint32_t dt){
#line 73
...
#line 132
{
  if (Project1C$connection[sim_node()]) {
      Project1C$Timer3$startOneShot(10000);
      return;
    }
  else {
#line 137
      Project1C$connectPAN();
    }
}
...
#line 292
{
  ...
  for (i = 0; i < 3; i++) {
      ...
      if (Project1C$sub_done[sim_node()][indx] == Project1C$sub_wish[sim_node()][indx]) 
        {
#line 301
          indx++;
        }
    }
  __nesc_hton_uint8(msg->type.nxdata, SUBSCRIBE);
  __nesc_hton_uint16(msg->id.nxdata, TOS_NODE_ID);
  __nesc_hton_uint8(msg->topic.nxdata, indx);

  sim_log_debug(167U, "subscribe", "CLIENT %d sending SUBSCRIBE on %s to PAN\n", TOS_NODE_ID, Project1C$topic_name[sim_node()][indx]);
  Project1C$generate_send(9, &Project1C$packet[sim_node()]);
  Project1C$Timer3$startOneShot(10000);
}
...
#line 315
  __nesc_hton_uint8(msg->type.nxdata, PUBLISH);
  __nesc_hton_uint16(msg->id.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(msg->payload.nxdata, Project1C$Random$rand16() % 101);
  __nesc_hton_uint8(msg->topic.nxdata, Project1C$topic_pub[sim_node()]);
  sim_log_debug(168U, "publish", "CLIENT %d sending PUBLISH: topic %s, value %d\n", TOS_NODE_ID, Project1C$topic_name[sim_node()][__nesc_ntoh_uint8(msg->topic.nxdata)], __nesc_ntoh_uint16(msg->payload.nxdata));
  Project1C$generate_send(9, &Project1C$packet[sim_node()]);
  Project1C$Timer3$startOneShot(10000);
}
...
#line 141
{
  if (Project1C$num_topic[sim_node()] == Project1C$num_sub[sim_node()]) {
      Project1C$publish();
      return;
    }
  else {
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb729c3a8){
#line 83
  switch (arg_0xb729c3a8) {
#line 83
    case 0U:
#line 83
      Project1C$Timer0$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      Project1C$Timer1$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      Project1C$Timer2$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      Project1C$Timer3$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb729c3a8);
#line 83
      break;
#line 83
    }
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static bool Project1C$Timer0$isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 92
#line 73
inline static void Project1C$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 324
{
  Project1C$message_list_t *new_message = (Project1C$message_list_t *)malloc(sizeof(Project1C$message_list_t ));

#line 326
  new_message->saved_msg = msg;
  new_message->dest_id = address;
  new_message->next = (void *)0;
  if (Project1C$is_empty_message_list(list)) {
      *list = new_message;
    }
  else {
      Project1C$message_list_t *current = *list;
...
#line 149
{
  ...
  if (Project1C$Timer0$isRunning()) {
      return FALSE;
    }
  else 
    {
      Project1C$queued_packet[sim_node()] = *packet;
      Project1C$queue_addr[sim_node()] = address;
      Project1C$Timer0$startOneShot(100);
      return TRUE;
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module Project1C */
  if (!strcmp(varname, "Project1C$sockfd"))
  {
    *addr = (uintptr_t)&Project1C$sockfd[__nesc_mote];
    *size = sizeof(Project1C$sockfd[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$servaddr"))
  {
    *addr = (uintptr_t)&Project1C$servaddr[__nesc_mote];
    *size = sizeof(Project1C$servaddr[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$packet"))
  {
    *addr = (uintptr_t)&Project1C$packet[__nesc_mote];
    *size = sizeof(Project1C$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$queued_packet"))
  {
    *addr = (uintptr_t)&Project1C$queued_packet[__nesc_mote];
    *size = sizeof(Project1C$queued_packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$queue_addr"))
  {
    *addr = (uintptr_t)&Project1C$queue_addr[__nesc_mote];
    *size = sizeof(Project1C$queue_addr[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$connection"))
  {
    *addr = (uintptr_t)&Project1C$connection[__nesc_mote];
    *size = sizeof(Project1C$connection[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$sub_wish"))
  {
    *addr = (uintptr_t)&Project1C$sub_wish[__nesc_mote];
    *size = sizeof(Project1C$sub_wish[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$sub_done"))
  {
    *addr = (uintptr_t)&Project1C$sub_done[__nesc_mote];
    *size = sizeof(Project1C$sub_done[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$num_topic"))
  {
    *addr = (uintptr_t)&Project1C$num_topic[__nesc_mote];
    *size = sizeof(Project1C$num_topic[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$num_sub"))
  {
    *addr = (uintptr_t)&Project1C$num_sub[__nesc_mote];
    *size = sizeof(Project1C$num_sub[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$topic_pub"))
  {
    *addr = (uintptr_t)&Project1C$topic_pub[__nesc_mote];
    *size = sizeof(Project1C$topic_pub[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$message_list"))
  {
    *addr = (uintptr_t)&Project1C$message_list[__nesc_mote];
    *size = sizeof(Project1C$message_list[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$client_list"))
  {
    *addr = (uintptr_t)&Project1C$client_list[__nesc_mote];
    *size = sizeof(Project1C$client_list[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$locked"))
  {
    *addr = (uintptr_t)&Project1C$locked[__nesc_mote];
    *size = sizeof(Project1C$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$topic_name"))
  {
    *addr = (uintptr_t)&Project1C$topic_name[__nesc_mote];
    *size = sizeof(Project1C$topic_name[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module Project1C */
  memset((void *)&Project1C$sockfd[__nesc_mote], 0, sizeof Project1C$sockfd[__nesc_mote]);
  memset((void *)&Project1C$servaddr[__nesc_mote], 0, sizeof Project1C$servaddr[__nesc_mote]);
  memset((void *)&Project1C$packet[__nesc_mote], 0, sizeof Project1C$packet[__nesc_mote]);
  memset((void *)&Project1C$queued_packet[__nesc_mote], 0, sizeof Project1C$queued_packet[__nesc_mote]);
  memset((void *)&Project1C$queue_addr[__nesc_mote], 0, sizeof Project1C$queue_addr[__nesc_mote]);
  Project1C$connection[__nesc_mote] = FALSE;
  memcpy((void *)&Project1C$sub_wish[__nesc_mote], (void *)&(unsigned char [3]){ FALSE, FALSE, FALSE }, sizeof Project1C$sub_wish[__nesc_mote]);
  memcpy((void *)&Project1C$sub_done[__nesc_mote], (void *)&(unsigned char [3]){ FALSE, FALSE, FALSE }, sizeof Project1C$sub_done[__nesc_mote]);
  memset((void *)&Project1C$num_topic[__nesc_mote], 0, sizeof Project1C$num_topic[__nesc_mote]);
  memset((void *)&Project1C$num_sub[__nesc_mote], 0, sizeof Project1C$num_sub[__nesc_mote]);
  memset((void *)&Project1C$topic_pub[__nesc_mote], 0, sizeof Project1C$topic_pub[__nesc_mote]);
  Project1C$message_list[__nesc_mote] = (void *)0;
  memset((void *)&Project1C$client_list[__nesc_mote], 0, sizeof Project1C$client_list[__nesc_mote]);
  memset((void *)&Project1C$locked[__nesc_mote], 0, sizeof Project1C$locked[__nesc_mote]);
  memcpy((void *)&Project1C$topic_name[__nesc_mote], (void *)&(char const *[3]){ [TEMPERATURE]  = "TEMPERATURE", [HUMIDITY]  = "HUMIDITY", [LUMINOSITY]  = "LUMINOSITY" }, sizeof Project1C$topic_name[__nesc_mote]);
